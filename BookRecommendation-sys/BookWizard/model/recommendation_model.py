...
# Load the dataset
books = pd.read_csv(r"C:\Users\USER\Desktop\BookWizard\BookWizard\database\books_new.csv")

# Drop rows with missing values
books.dropna(inplace=True)

# Drop 'Height' and 'Publisher' columns
books.drop(columns=['Height', 'Publisher'], inplace=True)
...
books['SubGenre'] = books['SubGenre'].apply(remove_stopwords)
...
books['SubGenre'] = books['SubGenre'].apply(stem_text)
...
books.to_csv(r"C:\Users\USER\Desktop\BookWizard\BookWizard\database\books_preprocessed.csv", index=False)


# Load the preprocessed dataset
books = pd.read_csv(r"C:\Users\USER\Desktop\BookWizard\BookWizard\database\books_new_updated.csv")
